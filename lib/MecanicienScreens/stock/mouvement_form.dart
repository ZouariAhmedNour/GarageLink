...
class MouvementFormScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MouvementFormScreen> createState() =>
      _MouvementFormScreenState();
}
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  for (final p in pieces)
                    DropdownMenuItem(
                      value: p.id,
                      child: Text('${p.sku} • ${p.nom} (Qt: ${p.quantite})'),
                    ),
                ],
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Référence doc (optionnel)',
                ),
              ),
              const SizedBox(height: 8),
              TextFormField(
              ...
              FilledButton(
                onPressed: () {
                  ...
                  if (widget.index == null) {
                    ...
                    ref
                        .read(mouvementProvider.notifier)
                        .updateMouvement(widget.index!, mvt);
                  }
                  Get.back();
                },
