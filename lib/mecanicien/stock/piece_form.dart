...
class _PieceFormScreenState extends ConsumerState<PieceFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.piece == null ? 'Nouvelle pièce' : 'Modifier la pièce',
        ),
      ),
      body: Padding(
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Emplacement (rayon/étagère)',
                  ),
                ),
                  ...
                  onPressed: () {
                    ...
                    if (widget.index == null) {
                      ...
                      ref
                          ...
                          .updatePiece(widget.index!, piece);
                    }
